...
metadata:
  ...
  labels:
    ...
    tier: frontend
  annotations:
    huyouba1.com/create-by:"cluster admin"
spec:
  containers:
  - name: myapp
...
```
[root@k8s-master volumes]# kubectl create configmap nginx-config --from-literal=nginx_port=80 --from-literal=server_name=myapp.huyouba1.com
...
metadata:
  ...
  labels: 
    ...
    tier: frontend
  annotations:
    huyouba1.com/created-by: "cluster admin"
spec:
  containers:
  - name: myapp
    image: ikubernetes/myapp:v1
